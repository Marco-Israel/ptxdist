...
#
#
#@brief     Downloads and installs docker frist. Can Add your user to docker.
#@details   The scrip is mostly based on the online script available online and
#           adds only the ability to add yourself (your user) to the docker
#           group in the end of this script. The original script is available
#           at  ' get.docker.com '  . You can call and run in directly via:
